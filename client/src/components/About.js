  ...
  return (
    <div className="about-page">
      <div className="about-section">
        ...
        <p className="about-text">DineMate was founded on the idea that sharing a meal with others is one of life's greatest pleasures. Our team of foodies and tech enthusiasts came together to create a platform that makes it easy for people to discover and book tables at their favorite restaurants.</p>
      ...
      <div className="mission-section">
        ...
        <div className="mission-grid">
          <div className="mission-item">
            ...
            <h3 className="mission-subtitle">Delicious Experiences</h3>
          ...
          <div className="mission-item">
            ...
            <h3 className="mission-subtitle">Community Building</h3>
          ...
          <div className="mission-item">
            ...
            <h3 className="mission-subtitle">Exceptional Service</h3>
      ...
      <div className="call-to-action">
        <p className="cta-text">Ready to start dining with DineMate? Browse our selection of top-rated restaurants and book a table today!</p>
