  ...
  return (
    <div className="about-page" style={{ backgroundColor: '#FF8C00', padding: '40px' }}>
      <div className="hero-section">
        <div className="hero-grid">
          ...
          <div className="hero-content" style={{ textAlign: 'center' }}>
            <h1 style={{ fontSize: '48px', color: 'white', marginBottom: '16px' }}>About DineEase</h1>
      ...
      <div className="about-section">
        ...
        <p style={{ fontSize: '18px', color: 'white', textAlign: 'center', lineHeight: '1.6', letterSpacing: '0.5px', marginBottom: '16px' }}>DineEase was founded on the idea that sharing a meal with others is one of life's greatest pleasures. Our team of foodies and tech enthusiasts came together to create a platform that makes it easy for people to discover and book tables at their favorite restaurants.</p>
      ...
      <div className="call-to-action" style={{ textAlign: 'center', marginTop: '40px' }}>
        ...
        <p style={{ fontSize: '18px', color: 'white', textAlign: 'center', lineHeight: '1.6', letterSpacing: '0.5px' }}>Ready to start dining with DineEase? Browse our selection of top-rated restaurants and book a table today!</p>
      </div>
    </div>
  );
};
